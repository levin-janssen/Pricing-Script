...
if (!empty($site_password)) {
    ...
    if (isset($_POST['login_password'])) {
        if ($_POST['login_password'] === $site_password) {
            ...
            // Nach dem Login auf die gleiche Seite weiterleiten, um erneutes Senden (F5) zu verhindern
    ...
    if (empty($_SESSION['is_logged_in'])) {
        ...
        <?php
        // Skript hier abbrechen, damit nachfolgende Inhalte geschützt bleiben
        exit; 
    }
}