...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        // 1. Alle alten, existierenden Favicons aus dem <head> der aktuellen Seite löschen
        document.querySelectorAll("link[rel~='icon'], link[rel='shortcut icon'], link[rel='apple-touch-icon']").forEach(el => el.remove());
        
        // 2. Unser neues, gestochen scharfes SVG-Icon erstellen
        const newIcon = document.createElement('link');
        newIcon.rel = 'icon';
        newIcon.type = 'image/svg+xml';
        newIcon.href = "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%232563eb' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z'></path><line x1='7' y1='7' x2='7.01' y2='7'></line></svg>";
        
        // 3. Hart in den <head> der Seite injizieren
